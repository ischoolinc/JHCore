...
{
    class TemplateLookupFieldValidator : IFieldValidator
    {
        ...
        public TemplateLookupFieldValidator(WizardContext context)
        {
            _context = context;
        }
        ...
        public void InitFromXMLNode(System.Xml.XmlElement XmlNode)
        {
            ...
            _lookup = _context.Extensions[TemplateLookup.Name] as TemplateLookup;
        }
